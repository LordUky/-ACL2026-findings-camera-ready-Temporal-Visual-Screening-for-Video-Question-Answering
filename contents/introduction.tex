...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{figs/task_compare_v3-emc.png}
...
This filter-before-reason economy is forced by VideoQA: a minute of video contains thousands of frames of which only a narrow band bears on any given query, yet current Video-LLMs \citep{chen2023video-LLMmodelingvideosequence,2023videochat,Xu2024PLLaVAP,maaz-etal-2024-video,10658165,Ma_2024_CVPR} typically fit the entire stream through a bounded visual-token budget via query-agnostic uniform sampling. This dilutes semantic signal at critical segments and injects noise, weakening supervision during training \citep{lin2024norton, knowledgeovershadowing} and reducing task-oriented focus at inference.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{figs/workflow_figure_new_eg-3_manlingstyle-emc.png}  
