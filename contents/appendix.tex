...
\section{Full Per-Source Caption Breakdown}
\label{appendix:efficiency_full}

For completeness, Table~\ref{tab:cost_full_breakdown} reports the full per-source caption decomposition for ReSimplifyIt, which is summarized only at a high level in Table~\ref{tab:cost_full} of the main paper. The columns are defined as follows:
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    ...
    \item \textbf{\#scan}, \textbf{\#localize}, \textbf{\#get\_cap}: the breakdown of VwTl into its three constituent tool types.
\end{itemize}
...
\begin{table*}[ht]
  ...
  \begin{tabular}{l|ccccc|ccc}
    \toprule
    \textbf{Dataset} & \textbf{Pasv} & \textbf{VaIn} & \textbf{LoIn} & \textbf{Actv} & \textbf{V$\rightarrow$Vw} & \textbf{\#scan} & \textbf{\#localize} & \textbf{\#get\_cap} \\
    \midrule
    ActivityNet-QA  & 34.0 & 17.4 & 16.6 & 33.5 & 2.7 & 2.6 & 1.7 & 2.4 \\
    YouCookII-TVS   & 38.2 & 22.8 & 15.4 & 35.7 & 2.4 & 3.0 & 1.5 & 1.1 \\
    NExT-OE         & 5.3  & 2.7  & 2.6  & 13.0 & 0.4 & 0.4 & 0.3 & 0.4 \\
    EgoSchema       & 24.5 & 13.6 & 10.8 & 26.1 & 2.3 & 2.5 & 1.1 & 0.8 \\
    LVBench         & 48.9 & 17.5 & 31.3 & 94.9 & 2.6 & 4.8 & 3.1 & 3.0 \\
    MLVU            & 22.1 & 9.8  & 12.3 & 42.4 & 1.7 & 2.1 & 1.2 & 1.6 \\
    Video-MME       & 32.8 & 15.0 & 17.8 & 43.4 & 2.4 & 3.3 & 1.8 & 1.5 \\
    \bottomrule
  \end{tabular}%
  }
  \caption{Full per-source caption breakdown for ReSimplifyIt. Values are averaged per sample. Passive captions are those embedded in agent prompts at initialization; active captions are fetched during tool execution. VwTl ($=\text{\#scan}+\text{\#localize}+\text{\#get\_cap}$) is reported in Table~\ref{tab:cost_full}.}
